...
import {
  ...
  type PalletPlan,
  type ItemPallet,
  type ItemPalletUpsert,
  type PalletStation,
  type PalletStationUpsert,
  type RobotDir,
  type RobotDirUpsert,
  type RobotDirView,
  type PalletSpec,
...
export const palletApi = {
  ...
  items: () => getJson<ItemPallet[]>('/api/pallet/items'),
  saveItem: (p: ItemPalletUpsert) => putJson<ItemPallet>('/api/pallet/items', p),
  deleteItem: (code: number) => del(`/api/pallet/items/${code}`),
  robots: () => getJson<RobotDirView[]>('/api/pallet/robots'),
  saveRobot: (r: RobotDirUpsert) => putJson<RobotDir>('/api/pallet/robots', r),
  stations: () => getJson<PalletStation[]>('/api/pallet/stations'),
  saveStation: (s: PalletStationUpsert) => putJson<PalletStation>('/api/pallet/stations', s),
  deleteStation: (station: number) => del(`/api/pallet/stations/${station}`),
