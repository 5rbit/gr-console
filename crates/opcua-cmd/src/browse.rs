...
/// Known leaf members of `LGR_Interface_GR_Command`, used only when browsing fails and
/// node ids have to be synthesized. Kinds are hints; the `DataType` attribute wins.
pub const KNOWN_MEMBERS: &[(&str, PlcKind)] = &[
    ...
    ("Command.Jog", PlcKind::U8),
    ("Command.B3_Spare", PlcKind::U8),
    ("Command.Home", PlcKind::U8),
    ("Command.MaintPos", PlcKind::U8),
    ("Command.CellOrigin", PlcKind::U8),
